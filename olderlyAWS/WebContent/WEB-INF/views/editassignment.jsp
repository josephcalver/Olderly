...
<!--
	function onDeleteClick(event) {
		var doDelete = confirm("Are you sure you want to delete this assignment?")
		if (doDelete == false) {
...
<div class="container">
	...
	<h2 class="page-heading">Edit / Delete Assignment</h2>
	<br /> <br />

	<div class="offset-sm-2 col-sm-10">

		<sf:form action="${pageContext.request.contextPath}/updateassignment"
			method="post" modelAttribute="assignment">

			<sf:input type="hidden" name="id" path="id" value="${assignment.id}" />
			...
			<div class="form-group row">
				<div class="offset-sm-2 col-sm-10">
					<a class="btn btn-primary" role="button"
						href="${pageContext.request.contextPath}/">Cancel</a> <input
						class="btn btn-primary" type="submit" name="update" value="Update" />
