...
<!--
	function onDeleteClick(event) {
		var doDelete = confirm("Are you sure you want to delete your account?")
		if (doDelete == false) {
			...
			<div class="form-group row">
				<div class="offset-sm-2 col-sm-10">
					<a class="btn btn-primary" role="button"
						...
						class="btn btn-primary" type="submit" value="Update" /> <input
						class="btn btn-primary" type="submit" name="delete" id="delete"
						value="Delete" />
				</div>
			</div>
		</sf:form>
